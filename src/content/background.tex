...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}[shorten >=1pt,node distance=3cm,on grid,auto] 
		...
		(q_12) edge [bend left=40] node [right] {$\neg b$ \{\textcolor{orange}{0}, \textcolor{cyan}{1}\}} (q_11)
		...
		(q_22) edge node [right] {$\neg b$} (q_21)
		(q_22) edge [bend left=40] node [right] {$b$ \{\textcolor{cyan}{1}\}} (q_21)
		(q_21) edge [bend left=40] node [right] {$a$} (q_23)
		(q_23) edge [bend left=40] node {$b$ $\{\textcolor{orange}{0}, \textcolor{cyan}{1}\}$} (q_21)
		(q_23) edge node [below] {$\neg b$ $\{\textcolor{orange}{0}\}$} (q_21)
